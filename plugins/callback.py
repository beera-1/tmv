                ...
                [
                    [
                        ...
                        InlineKeyboardButton(
                            "Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ ⌘", url="https://t.me/MOVIES_ADDDDA"
                        ),
                    ],
        ...
        await msg.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "Uᴘᴅᴀᴛᴇs 🙌", url="https://t.me/MOVIES_ADDDDA"
                        ),
                        InlineKeyboardButton(
                            "Dᴇᴠᴇʟᴏᴘᴇʀ ⚡", url="https://t.me/MOVIES_ADDDDA"
                        ),
                    ],
        ...
        await msg.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            "Cʜᴀɴɴᴇʟ", url=f"https://t.me/MOVIES_ADDDDA"
                        ),
                        InlineKeyboardButton(
